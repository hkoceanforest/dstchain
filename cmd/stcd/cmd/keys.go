...
import (
	...
	evmosclient "github.com/evmos/ethermint/client"
...
`,
	...
	cmd.AddCommand(
		...
		keys.MigrateCommand(),
		flags.LineBreak,
		evmosclient.UnsafeExportEthKeyCommand(),
		evmosclient.UnsafeImportKeyCommand(),
	)
...
func runAddCmd(cmd *cobra.Command, args []string) error {
	...
	return KeyAddCmd(clientCtx, cmd, args, buf)
}

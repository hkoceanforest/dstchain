	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			seeds := []string{
				...
				"07bd36e81b63a2a9f8b862eda3e6d94a4e08f13f@enhancecommunication.chat:26656",
				"61b6467e6d936d7d72ecbcb6cb0519393feb3371@www.free2030.com:26656",
				"9333d7d30b8e0ac7da5548bcdf64ea4438330957@chat.futurecommunication.cc:26656",
			}
			...
			if chainID == "" {
				chainID = fmt.Sprintf("evmos_7777-%v", tmrand.Str(6))
			}

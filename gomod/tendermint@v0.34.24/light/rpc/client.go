...
func (c *Client) PoolFirstAndLastTxs(ctx context.Context) (*ctypes.PoolFirstAndLastTxs, error) {
	return c.next.PoolFirstAndLastTxs(ctx)
}

func (c *Client) TxExisted(ctx context.Context,tx types.Tx) (*ctypes.ResultTxExisted, error) {
	return c.next.TxExisted(ctx,tx)
}

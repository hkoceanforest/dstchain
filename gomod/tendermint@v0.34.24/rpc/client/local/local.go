...
func (c *Local) TxExisted(ctx context.Context,tx types.Tx) (*ctypes.ResultTxExisted, error) {
	return core.TxExisted(c.ctx,tx)
}

func (c *Local) PoolFirstAndLastTxs(ctx context.Context) (*ctypes.PoolFirstAndLastTxs, error) {
	return core.PoolFirstAndLastTxs(c.ctx)
}

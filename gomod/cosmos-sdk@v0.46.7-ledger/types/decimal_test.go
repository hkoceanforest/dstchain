...
func TestDec(t *testing.T) {
	dec1 := sdk.NewDec(100)
	t.Log(dec1.IsPositive())

	dec2 := sdk.NewDec(0)
	t.Log(dec2.IsPositive())

	dec3 := sdk.NewDec(1)
	t.Log(dec3.IsPositive())

	dec4, _ := sdk.NewDecFromStr("0.1")
	t.Log(dec4.IsPositive())

	dec5, _ := sdk.NewDecFromStr("-1")
	t.Log(dec5.IsPositive())
}

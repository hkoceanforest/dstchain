...
func NewSimApp(
	...
	*/
	app.GroupKeeper = groupkeeper.NewKeeper(keys[group.StoreKey], appCodec, app.MsgServiceRouter(), app.AccountKeeper, app.BankKeeper, groupConfig, app.GetSubspace(group.ModuleName))

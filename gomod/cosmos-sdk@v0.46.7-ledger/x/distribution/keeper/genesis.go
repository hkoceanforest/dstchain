...
func (k Keeper) InitGenesis(ctx sdk.Context, data types.GenesisState) {
	...
	fmt.Println("moduleHoldings", moduleHoldings.AmountOf("nxn"))

	moduleHoldings = moduleHoldings.Add(data.FeePool.CommunityPool...)
	fmt.Println("communityPool:", data.FeePool.CommunityPool.AmountOf("nxn"))

	fmt.Println("moduleHoldings", moduleHoldings.AmountOf("nxn"))

	moduleHoldingsInt, _ := moduleHoldings.TruncateDecimal()
	fmt.Println("moduleHoldingsInt:", moduleHoldingsInt.AmountOf("nxn"))
	...
	fmt.Println("module account :", moduleAcc.GetAddress().String)
	fmt.Println("distribution module balance:", balances.AmountOf("nxn"))

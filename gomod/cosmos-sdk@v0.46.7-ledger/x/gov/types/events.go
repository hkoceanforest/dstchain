...
const (
	...
	AttributeKeyProposalDepositer  = "proposal_depositer"

	AttributeKeyProposalDepositeRefund = "proposal_deposite_refund"
	AttributeKeyProposalDepositeAmount = "proposal_deposite_amount"
)

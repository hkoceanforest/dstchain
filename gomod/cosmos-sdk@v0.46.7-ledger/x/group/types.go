...
const (
	EventTypeGroupDeposit       = "group_proposal_deposit"
	AttributeGroupProposer      = "group_proposer"
	AttributeGroupAmount        = "group_deposit_amount"
	AttributeGroupModuleAddress = "group_module_address"
)
